 ...
 * February 2025
 *
 * This file gives functionality for surveys to be submitted,
 * and for navigating between pages of the survey.
 */
...
(function() {
   ...
   * @returns {boolean} false if form is submitted
   */
  function nextPrev(n) {
  ...
  function stars(){
    ...
    starRatings.forEach(rating => {
       ...
       * @param {object} star to be highlighted
       */
       ...
       * @param {object} star to highlight to (inclusive)
       */
